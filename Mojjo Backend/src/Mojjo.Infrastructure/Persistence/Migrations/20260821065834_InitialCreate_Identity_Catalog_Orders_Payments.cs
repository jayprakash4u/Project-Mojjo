...
{
    /// <inheritdoc />
    public partial class InitialCreate_Identity_Catalog_Orders_Payments : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RewardCoinBalance = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StandardEtaMinutes = table.Column<int>(type: "int", nullable: false),
                    ExpressEtaMinutes = table.Column<int>(type: "int", nullable: false),
                    IsExpressAvailable = table.Column<bool>(type: "bit", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeliveryAgentId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    Shipping_FullName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Shipping_Phone = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Shipping_StreetAddress = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Shipping_City = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Shipping_Area = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Shipping_Landmark = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Type = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ReferenceOrderId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RewardCoinTransactions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RewardCoinTransactions_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Pidx = table.Column<string>(type: "nvarchar(450)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RewardCoinsEarned = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    ProductId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    PreviousPhysicalStock = table.Column<int>(type: "int", nullable: false),
                    NewPhysicalStock = table.Column<int>(type: "int", nullable: false),
                    QuantityChanged = table.Column<int>(type: "int", nullable: false),
                    Reason = table.Column<int>(type: "int", nullable: false),
                    Note = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    OperatorUserId = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DeliveryAreas_IsActive_Name",
                table: "DeliveryAreas",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PaymentTransactions_Pidx",
                table: "PaymentTransactions",
                column: "Pidx");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_Badge_Rating",
                table: "Products",
                columns: new[] { "Badge", "Rating" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_CategoryId_Rating",
                table: "Products",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RewardCoinTransactions_UserId_CreatedAt",
                table: "RewardCoinTransactions",
                columns: new[] { "UserId", "CreatedAt" });
